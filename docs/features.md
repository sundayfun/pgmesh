...
| OpenTelemetry metrics and traces | Wrapper/logical/physical latency, per-node throughput and in-flight work, COPY telemetry | [Enable OpenTelemetry](how-to/enable-opentelemetry.md) | Application Collector/exporter configuration |
